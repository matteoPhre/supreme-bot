...
public class CheckoutPage extends Page {
    ...
    private static final By sCCNCardType = By.xpath("//div[@id='cart-cc']/div[0]/select[@id='credit_card_type']");
    private static final By sCCNumberLocator = By.xpath("//div[@id='card_details']/div[1]/input[@id='cnb']");
    ...
    private static final By sCCPinLocator = By.xpath("//div[@id='card_details']/div[2]/div[2]/input[@id='vval']");
    ...
    private static final By sCaptchaLocator = By.xpath("/html/body/div[1]");
    ...
    public void fillInfo() {
        ...
        String type = (String) infoJSON.get("card_type");
